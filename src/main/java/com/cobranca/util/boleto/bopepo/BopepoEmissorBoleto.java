package com.cobranca.util.boleto.bopepo;
...
import com.cobranca.util.modulo11.GeradorDigitoVerificador;
...
public class BopepoEmissorBoleto implements EmissorBoleto {
	...
	public byte[] gerarBoleto(com.cobranca.model.Cedente cedenteSistema
	...
	public File gerarBoletoEmArquivo(String arquivo, com.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
		Boleto boleto = criarBoleto(cedenteSistema, cobrancaSistema);
	...
	private Boleto criarBoleto(com.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
	...
	private ContaBancaria criarContaBancaria(com.cobranca.model.Cedente cedenteSistema) {
	...
	private Titulo criarTitulo(ContaBancaria contaBancaria, Sacado sacado, Cedente cedente
			, com.cobranca.model.Cobranca cobrancaSistema) {
